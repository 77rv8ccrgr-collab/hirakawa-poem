...
-536
    ...
    columns: [
        ...
        "◾️どど（👣どど◾️うか無限●チューリ●ップに（反◾️復",

        "す（る👣お姉さん●地下通路を◾️どど（ど👣歩き●な👣、",

        "（がら、●風◾️景ロドリゲス👣のな●か（、に◾️ど（粉",

        "◾️ど（れ込んだ●微細な👣異変を◾️ど●発見👣するっ（、",

        "と◾️どど（ど◾️の👣と👣いうも●のであ👣るが、◾️どど",

        "（ど◾️れを●くびって（眼帯スーツケース👣が（こ👣の",

        "◾️（どど●ゲーム戦場◾️に（、魅●入ら（（👣れ👣た理、",

        "由は、👣肺の構造8 番出口👣が、いる　。◾️ど●どんな",

        "（に●同じ通●路を(何度も👣歩くあ👣るいている同👣",

        "👣ひん剥き目だま蛍光灯👣の下（、を何◾️どど（●も通",

        "過する👣していく。👣赤い塗料とも◾️どど👣ねむりなよ、"
